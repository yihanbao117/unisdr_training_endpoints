...
from constants import Language  # ETT Language Enums 
...
class TrainThemeUpload(Resource):


    def __init__(self):

        TrainThemeUpload.input_data = " "
...
class TrainTheme(Resource):
    ...
    def post(self):
        ...
        data = ett_t.transform_data_to_dataframe_basic(TrainThemeUpload.input_data, colnames)
